package com.dr.nlp.part3.Runners;

import com.dr.nlp.part3.dataStructures.DataFile;
import com.dr.nlp.part3.dataStructures.Paragraph;
import com.dr.nlp.part3.dataStructures.Sentence;
import com.dr.nlp.part3.dataStructures.Word;
import com.dr.nlp.part3.util.NLPDataReader;
import com.dr.nlp.part3.util.NamedEntityList;
import com.dr.nlp.part3.util.ObjectToXML;
...
public class DataReader {
  ...
  public DataFile readDataFromFile(String fileName) {
    ...
    BufferedReader newReader = NLPDataReader.readInputFile(inputFile);
    DataFile dataFile = new DataFile(inputFile);
    try {
    ...
    for (String st : nerList) {
      ...
      for (Paragraph p : dataFile.getParagraphList()) {
        for (Sentence s : p.getSentences()) {
          List<Word> wList = s.getWords();
